...
#ifdef LDS_ADD_EG_2_4_MONSTER_ERCANNE
	case 507:
		{
...
//			BoneManager::RegisterBone(pCharacter, "node_blade03" ,75);
	...
	case 513:
		...
		break;
#ifdef LDS_ADD_EG_MONSTER_GUARDIANDEFENDER
	case 518:
		{
...
#else // LDS_ADD_EG_ADDMONSTER_ACTION_GUARDIANDEFENDER_EX2
			VectorCopy( o->Angle, o->HeadTargetAngle );
#endif // LDS_ADD_EG_ADDMONSTER_ACTION_GUARDIANDEFENDER_EX2
		}
		return true;
	...
	case MODEL_MONSTER01+167:
		{
			...
			case MONSTER01_ATTACK3:
				{
					PlayBuffer( SOUND_EMPIREGUARDIAN_ERCANNE_MONSTER_ATTACK03 );
				}
				break;
			case MONSTER01_APEAR:
				{
	...
	case MODEL_MONSTER01+168:
		{
			...
			case MONSTER01_ATTACK2:
				{
					PlayBuffer(SOUND_EMPIREGUARDIAN_1CORP_DEASULER_MONSTER_ATTACK02);
				}
				break;
			case MONSTER01_ATTACK3:
				{
					PlayBuffer(SOUND_EMPIREGUARDIAN_1CORP_DEASULER_MONSTER_ATTACK03);
				}
				break;
			case MONSTER01_APEAR:
				{
