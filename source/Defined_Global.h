...
#define UPDATE_100527
	...
	#define ADD_TOTAL_CHARGE_8TH
		...
		#define ADD_SKELETON_PET							// 스켈레톤 펫 (2009.12.03)
			...
			#define YDG_FIX_CHANGERING_STATUS_EXPIRE_CHECK	// 변신반지 스탯올릴때 만료 체크 (2010.01.25)
			#define LDK_FIX_PC4_GUARDIAN_DEMON_INFO			// 데몬 캐릭터정보창에 공격력,마력,저주력 추가 데미지 적용(09.10.15) - 캐릭터정보창에 펫 종류에 의한 저주력 추가 데미지를 적용 시키기 위해 추가
...
#define ADD_TOTAL_CHARGE_6TH
	...
	// 3. PC 방 시스템 및 아이템
	// ---------------------------------------------------------------------------
	#define	ADD_PCROOM_POINT_SYSTEM				// 일본 PC방 시스템 적용. (2009.03.25)
	...
	#define ADD_FIX_AFTER_6TH_TEST
		...
		#define PBG_MOD_MASTERLEVEL_MESSAGEBOX							// 상승의 인장 마스터케릭터 구입여부 추가(09.04.24)
